...
const linkCards = [
  {
    ...
    description: `Do you know somewhere in <span class="font-semibold">${props.countyName}</span> that offers gluten free that we don't have listed? Let us know!`,
    icon: DocumentArrowUpIcon,
    href: '/wheretoeat/recommend-a-place',
  },
  {
    title: 'Map',
    description: `Browse an interactive map of <span class="font-semibold">${props.countyName}</span> with all of the places we know about marked that offer gluten free!`,
    icon: MapIcon,
    href: `/wheretoeat/browse/${props.latlng}/10.9${props.additionalMapUrl}`,
  },
];
</script>
