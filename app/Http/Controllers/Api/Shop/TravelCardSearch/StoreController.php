...
{
    public function __invoke(TravelCardSearchRequest $request, SearchTravelCardCountyOrLanguageAction $searchTravelCardCountyOrLanguageAction, TravelCardSearchAiLookup $travelCardSearchAiLookup): array
    {
