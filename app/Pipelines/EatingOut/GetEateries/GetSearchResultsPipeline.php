...
class GetSearchResultsPipeline
{
     ...
     */
    public function run(EaterySearchTerm $eaterySearchTerm, array $filters, string $sort = 'distance', string $jsonResource = EateryListResource::class): LengthAwarePaginator
    {
        $pipes = [
