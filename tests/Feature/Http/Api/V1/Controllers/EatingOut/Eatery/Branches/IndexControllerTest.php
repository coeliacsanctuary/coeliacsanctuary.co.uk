...
namespace Tests\Feature\Http\Api\V1\Controllers\EatingOut\Eatery\Branches;
...
class IndexControllerTest extends TestCase
{
    ...
    {
        $this->getJson(route('api.v1.eating-out.details.branches.index', $this->eatery))->assertForbidden();
    }
    ...
    {
        return $this->getJson(
            route('api.v1.eating-out.details.branches.index', ['eatery' => $this->eatery, ...$params]),
