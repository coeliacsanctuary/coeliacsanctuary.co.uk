            ...
            ->assertInertia(
                fn (Assert $page) => $page
                    ...
                    ->has(
                        'collections.data',
                        12,
                        fn (Assert $page) => $page->hasAll(['title', 'description', 'date', 'image', 'header_image_alt_text', 'link', 'items'])
                    )
            ...
            ->assertInertia(
                fn (Assert $page) => $page
                    ...
                    ->has(
                        ...
                        12,
                        fn (Assert $page) => $page
                            ->hasAll(['title', 'description', 'date', 'image', 'header_image_alt_text', 'link', 'items'])
                    )
