...
class ListPopularEateriesInAreaTest extends TestCase
{
    ...
    protected function handleTool(string $area = 'Primrose Hill'): array
    {
        return json_decode((string) (new ListPopularEateriesInArea())->handle(new Request(['area' => $area])), true);
    }

    #[Test]
    public function itReturnsTheEateriesInTheGivenArea(): void
    {
    ...
    #[Test]
    public function itDoesntReturnEateriesFromOtherAreas(): void
    {
        ...
        $otherArea = $this->create(EateryArea::class, ['town_id' => $otherTown->id, 'area' => 'Foo']);
    ...
    public function itThrowsAnExceptionWhenTheTownDoesntExist(): void
    {
        ...
        $this->handleTool('Nonexistent Area');
    }

    #[Test]
    public function itHasTheCorrectSchema(): void
    {
        $schema = (new ListPopularEateriesInArea())->schema(new JsonSchemaTypeFactory());
