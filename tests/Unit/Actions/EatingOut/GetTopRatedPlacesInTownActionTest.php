...
class GetTopRatedPlacesInTownActionTest extends TestCase
{
    ...
    {
        $eateries = $this->callAction(GetTopRatedPlacesInTownAction::class, $this->town);
    ...
    public function itCachesTheMostRatedPlaces(): void
    {
        ...
        $this->callAction(GetTopRatedPlacesInTownAction::class, $this->town);
