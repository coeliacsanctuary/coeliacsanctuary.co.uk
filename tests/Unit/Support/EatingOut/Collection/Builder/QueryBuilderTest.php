...
namespace Tests\Unit\Support\EatingOut\Collection\Builder;
...
class QueryBuilderTest extends TestCase
{
    ...
    {
        $sql = new QueryBuilder(new Configuration())->toSql();

        $this->assertStringContainsString('select `wheretoeat`.`id`', $sql);
    }
    ...
    public function itCanFilterOnCountsFromACountObject(): void
    {
        ...
        $sql = new QueryBuilder(new Configuration(counts: [$count]))->toSql();
    ...
    public function itCanFilterOnAveragesFromAnAverageObject(): void
    {
        ...
        $sql = new QueryBuilder(new Configuration(averages: [$average]))->toSql();
    ...
    public function itCanHaveAJoinAddedFromAJoinObject(): void
    {
        ...
        $sql = new QueryBuilder(new Configuration(joins: [$join]))->toSql();
    ...
    public function itCanHaveASimpleWhereAppliedFromAWhereObject(): void
    {
        ...
        $sql = new QueryBuilder(new Configuration([$where]))->toSql();
    ...
    public function itCanHaveMultipleWheresAppliedWithAnOrFromAnObject(): void
    {
        ...
        $sql = new QueryBuilder(new Configuration([$firstWhere, $orWhere]))->toSql();
    ...
    public function itCanHaveMultipleWheresAppliedWithAnAndFromAnObject(): void
    {
        ...
        $sql = new QueryBuilder(new Configuration([$firstWhere, $andWhere]))->toSql();
    ...
    public function itCanHaveNestedWheresAppliedAsObject(): void
    {
        ...
        $sql = new QueryBuilder(new Configuration([$baseWhere, [$firstNestedWhere, $secondNestedWhere]]))->toSql();
    ...
    public function itCanHaveAnOrderClauseAddedAsObject(): void
    {
        ...
        $sql = new QueryBuilder(new Configuration(orderBy: [$order]))->toSql();
    ...
    public function itCanHaveMultipleOrderClausesAddedAsObject(): void
    {
        ...
        $sql = new QueryBuilder(new Configuration(orderBy: [$firstOrder, $secondOrder]))->toSql();
    ...
    {
        $sql = new QueryBuilder(new Configuration(limit: 100))->toSql();
